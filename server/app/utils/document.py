...
def convert_pdf_to_images(pdf_base64: str, max_pages: Union[int, None] = None) -> List[str]:
    """
...
async def get_document_base64_and_content(document_id: str, db_session: Any) -> Dict[str, str]:
        ...
        try:
            ...
            try:
                ...
                if document:
                    ...
                    db_session.commit()
                    logger.info(f"Updated document {document_id} with extracted PDF content")
                else:
...
async def upload_template_to_supabase_storage(template_code: str, scenario_id: str) -> None:
