...
const getFeedbackInstructions = (trainingType: 'interview' | 'offboarding' | 'preparation', cheating: boolean = false) => {
    if (trainingType === 'offboarding') {
        ...
        - Focus on professionalism, empathy, clarity of next steps, and clear communication.
        ...
        - Consider emotional aspects, clarity of next steps, and professionalism.
        ...
        - Focus on emotional distress, confusion about next steps, or communication issues
